...
class Strategy_CCI_period_imag(Strategy):

    def __init__(self, **kwargs):
        if len(kwargs)>0:
            super(Strategy_CCI_period_imag, self).__init__(kwargs)
    ...
    def graph(self):
        ...
        line5 = axs[1].plot(self.bot.data_active['date_time'], self.bot.data_active['cci_imag'],color='blue', linewidth=0.75)
        axs[2].set_ylim(0,50)
