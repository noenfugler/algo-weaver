...
class Strategy_Ehlers_Detrender(Strategy):

    def __init__(self, **kwargs):
        if len(kwargs)>0:
            super(Strategy_Ehlers_Detrender, self).__init__(kwargs)
    ...
    def should_long(self):
        ...
        if self.bot.position > 0:
            ...
            return self._cross_over_value('detrender', 0.0)
    ...
    def should_modify_long(self):
        ...
        if self.bot.position <= 0:
            ...
            return self._cross_under_value('detrender', 0.0)
