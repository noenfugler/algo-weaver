...
class Strategy_ehlers_trend_vigor_indicator(Strategy):

    def __init__(self, **kwargs):
        if len(kwargs)>0:
            super(Strategy_ehlers_trend_vigor_indicator, self).__init__(kwargs)
    ...
    def should_long(self):
        ...
        if self.bot.position > 0:
            ...
            return False #self._cross_over('eoti_quotient1', '0')
    ...
    def should_modify_long(self):
        ...
        if self.bot.position <= 0:
            ...
            return False #self._cross_under('eoti_quotient2', '0')
