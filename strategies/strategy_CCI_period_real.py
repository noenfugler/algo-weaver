...
class Strategy_CCI_period_real(Strategy):

    def __init__(self, **kwargs):
        if len(kwargs)>0:
            super(Strategy_CCI_period_real, self).__init__(kwargs)
    ...
    def graph(self):
        ...
        line1 = axs[0].plot(self.bot.data_active['date_time'], self.bot.data_active['mama'],color='green', linewidth=0.75)
