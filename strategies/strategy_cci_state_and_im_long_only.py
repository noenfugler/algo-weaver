...
class Strategy_CCI_long_only(Strategy):
    ...
    def should_long(self):
        ...
        if self.bot.position > 0:
            ...
            return self.bot.data.loc[last_row-1, 'cci_state'] == 1 or \
                   self.bot.data.loc[last_row-1, 'cci_state'] == 0 and \
                   self.bot.data.loc[last_row-1, 'cci_imag'] > self.bot.data.loc[last_row-1, 'cci_real']
