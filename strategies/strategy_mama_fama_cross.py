...
class Strategy_mama_fama_cross(Strategy):

    def __init__(self, **kwargs):
        if len(kwargs)>0:
            super(Strategy_mama_fama_cross, self).__init__(kwargs)
    ...
    def should_long(self):
        ...
        if self.bot.position > 0:
            ...
            return self._cross_over('mama', 'fama')
    ...
    def should_modify_long(self):
        ...
        if self.bot.position <= 0:
            ...
            return self._cross_under('mama', 'fama')
