...
from binance_futures.client import Client as Futures_Client
...
class Exchange_Binance_Spot(Exchange):
    def __init__(self, kwargs):
        ...
        self.api_key = "Add Binance Spot API Key Here"
...
class Exchange_Binance_Futures(Exchange):
    def __init__(self, kwargs):
        ...
        self.secret_key = "Add Binance Futures Secret Key Here"
        self.taker_fee = 0.0004
        self.maker_fee = 0.0001
        self.live = False
        self.can_short = True
