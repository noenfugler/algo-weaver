...
class Graph_Detrender(Graph):
    def __init__(self, **kwargs):
        super(Graph_Detrender, self).__init__(**kwargs)
    ...
    def graph(self):
        ...
        axs[1].set_title('Detrender')
        # line4 = axs[1].plot(self.strategy.bot.data_active['date_time'], self.strategy.bot.data_active['0'],color='grey', linewidth=0.75)
        line4 = axs[1].plot(self.strategy.bot.data_active['date_time'], self.strategy.bot.data_active['detrender'],color='green', linewidth=0.75)
        ...
        axs1b = axs[1].twinx()
        axs1b.plot(self.strategy.bot.data_active['date_time'], self.strategy.bot.data_active['detrender_period'],color='purple', linewidth=0.75)
