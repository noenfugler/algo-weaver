...
class Graph_ACP_2by2(Graph):
    def __init__(self, **kwargs):
        super(Graph_ACP_2by2, self).__init__(**kwargs)
        self.short_title = 'ACP 2by2'
    ...
    def graph(self, save=False):
        ...
        axs[0,0].set_title('50% ACP2 strength (black), ACP2 strength (purple), ACP3 strength (pink)')
