...
class Graph_mama_fama_cross(Graph):
    def __init__(self, **kwargs):
        super(Graph_mama_fama_cross, self).__init__(**kwargs)
        self.short_title = 'mama fama cross'
    ...
    def graph(self, save=False):
        ...
        line1 = axs.plot(self.strategy.bot.data_active['date_time'], self.strategy.bot.data_active['cci_period'],color='red', linewidth=0.75, zorder=4)
        axs.set_ylim(0,40)
