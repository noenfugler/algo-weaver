...
# from datasets.Binance_Spot_BTCAUD_1h_1000_candles import Dataset_Binance_Spot_BTCAUD_1h_1000_candles
from datasets.Binance_Spot_BTCAUD_1h_100_candles import Dataset_Binance_Spot_BTCAUD_1h_100_candles
from datasets.Binance_Spot_BTCAUD_1h_250_candles import Dataset_Binance_Spot_BTCAUD_1h_250_candles
...
class Backtest_CCI_ETHBTC_1h(Backtest):
    ...
    def initialise(self, **kwargs):
        ...
        self.instrument = Instrument_BTCAUD()

        self.interval = '1h'

        self.live=False

        self.dataset = Dataset_Binance_Spot_BTCAUD_1h_250_candles(exchange=self.exchange, \
                                                                      live=False, \
