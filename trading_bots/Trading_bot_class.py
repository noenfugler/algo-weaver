...
class Trading_Bot():
        ...
        if self.live:
            ...
            while not self.dataset.finished:
                ...
                if self.strategy.should_long():
                    ...
                    self.ls_trades.append(this_order.fulfill(timestamp=this_order.timestamp, price=self.get_last_close()))  #TODO:  I think this timestamp is 1 too early.
                ...
                if self.strategy.should_modify_short():
                    ...
                    self.ls_orders.append(this_order)
                    self.ls_trades.append(this_order.fulfill(bot=self, timestamp=this_order.timestamp, price=self.get_last_close()))  #TODO:  I think this timestamp is 1 too early.
                    # self.modify_position(this_order.quantity)
    ...
    #     this_order = Order()
    #     this_order.create_order(symbol=self.instrument.symbol, )
